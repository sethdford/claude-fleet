...
const STATIC_COMMANDS: Command[] = [
  ...
  { id: 'nav-hive', label: 'Go to Hex Hive', section: 'Navigation', icon: '\u2B21', action: () => { window.location.hash = '/hive'; } },
  { id: 'nav-memory', label: 'Go to Memory & Routing', section: 'Navigation', icon: '\u{1F4A1}', action: () => { window.location.hash = '/memory'; } },
  { id: 'nav-operations', label: 'Go to Operations', section: 'Navigation', icon: '\u2699', action: () => { window.location.hash = '/operations'; } },
  { id: 'nav-audit', label: 'Go to Audit', section: 'Navigation', icon: '\u{1F50D}', action: () => { window.location.hash = '/audit'; } },
  { id: 'nav-search', label: 'Go to Search & Analysis', section: 'Navigation', icon: '\u{1F50E}', action: () => { window.location.hash = '/search'; } },
  { id: 'nav-templates', label: 'Go to Templates', section: 'Navigation', icon: '\u{1F4CB}', action: () => { window.location.hash = '/templates'; } },
